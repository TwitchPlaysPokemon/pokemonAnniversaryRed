...
VermilionCityScriptPointers: ; 197dc (6:57dc)
	...
	dw VermilionCityScript5
	dw VermilionCityScript6
...
VermilionCityScript5:
	...
	ld a, [W_YCOORD]
	cp $1f
	ld de, SailorIslandMovement
	jr nz, .normal
	ld de, SailorIslandMovement2 ; preventing sailor walking over the player
.normal
	ld a, $3
	ld [$ff8c], a
	call MoveSprite ; change the warp to island
	ld a, LASTISLAND_1F
	ld [wWarpEntries + $17], a
	ld [wWarpEntries + $1b], a
	ld a, $6
	ld [W_VERMILIONCITYCURSCRIPT], a
	ret
	
VermilionCityScript6:
	ld a, [wcf0f] ; is he finished walking?
	and a
	ret nz
	xor a
	ld [W_VERMILIONCITYCURSCRIPT], a
...
SailorIslandMovement:
	db 0, 0, 0, 0, 0, 0, $ff
	
SailorIslandMovement2:
	db $80, 0, 0, 0, 0, 0, 0, $ff
...
SailorText:
	TX_FAR _SailorIslandText
	db "@"
	
SailorText2:
	TX_FAR _SailorIslandText2
	db "@"
	
SailorText3:
	TX_FAR _SailorIslandText3
	db "@"