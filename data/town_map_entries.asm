ExternalMapEntries: ; 71313 (1c:5313)
	...
	EMAP $2,$1,MtSilverName
	EMAP $7,$A,LastIslandName
	EMAP $0,$0,BattleTentName
...
InternalMapEntries: ; 71382 (1c:5382)
	...
	IMAP $F9,$2,$1,MtSilverName
	IMAP $FA,$7,$A,LastIslandName
	IMAP $FB,$7,$A,LastIslandName
	IMAP $FC,$7,$A,LastIslandName
	IMAP $FD,$7,$A,LastIslandName
	IMAP $FE,$7,$9,LastIslandName
	IMAP $FF,$7,$6,BattleTentName
