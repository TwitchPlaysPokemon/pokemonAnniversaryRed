CeladonMart3Object: ; 0x482c4 (size=94)
	...
	db $c ; signs
	db $4, $2, $6 ; CeladonMart3Text6 SNES
	db $4, $3, $7 ; CeladonMart3Text7
	db $4, $5, $8 ; CeladonMart3Text8 SNES
	...
	; db SPRITE_MART_GUY, $5 + 4, $11 + 4, $ff, $d4, $12 ; person
	; db SPRITE_MART_GUY, $5 + 4, $12 + 4, $ff, $ff, $13 ; person
	; db SPRITE_MART_GUY, $5 + 4, $13 + 4, $ff, $ff, $14 ; person
