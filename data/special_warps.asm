...
DungeonWarpList: ; 63bf (1:63bf)
	...
	db MANSION_1,$02
	db MANSION_2,$03
	db LASTISLAND_B1F,$01
	db LASTISLAND_B1F,$02
	db LASTISLAND_B1F,$03
	db LASTISLAND_B1F,$04
	db LASTISLAND_B1F,$05
	db LASTISLAND_B1F,$06
	db LASTISLAND_B1F,$07
	db LASTISLAND_B1F,$08
	db LASTISLAND_B1F,$09
	db LASTISLAND_B1F,$0a
	db LASTISLAND_1F,$01
	db LASTISLAND_1F,$02
	db LASTISLAND_1F,$03
	db LASTISLAND_1F,$04
...
DungeonWarpData: ; 63d8 (1:63d8)
	...
	FLYWARP_DATA LASTISLAND_B1F_WIDTH,$08,$0e
	FLYWARP_DATA LASTISLAND_B1F_WIDTH,$08,$0e
	FLYWARP_DATA LASTISLAND_B1F_WIDTH,$08,$0e
	FLYWARP_DATA LASTISLAND_B1F_WIDTH,$08,$0e
	FLYWARP_DATA LASTISLAND_B1F_WIDTH,$08,$0e
	...
	FLYWARP_DATA LASTISLAND_B1F_WIDTH,$08,$0e
	FLYWARP_DATA LASTISLAND_B1F_WIDTH,$08,$0e
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$0E,$03
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$0D,$05
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$05,$06
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$0D,$06
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$07,$0A
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$0D,$0A
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$05,$0B
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$0C,$0E
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$07,$0F
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$09,$11
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$02,$15
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$09,$15
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$0E,$18
	FLYWARP_DATA LASTISLAND_1F_WIDTH,$02,$16
...
MtSilverSpec:
	db MTSILVER
	FLYWARP_DATA MTSILVER_WIDTH,32,9
	db CAVERN
