...
wDoNotWaitForButtonPressAfterDisplayingText:: ; cc3c longest label ever WutFace
...
SECTION "wHack", WRAMX[$def0], BANK[1]
wPlayerGender:: ds 1
wRoamingFlag:: ds 1
wReappearCounter:: ds 3
wRematchFlag:: ds 1
wRemFuncArg:: ds 1
W_MTSILVERCURSCRIPT:: ds 1
W_LASTISLANDCURSCRIPT:: ds 1
W_BATTLETENTCURSCRIPT:: ds 1
wRanFlag:: ds 1
wBTOrder:: ds 2
wBTStreakCnt:: ds 1
wBTClass:: ds 1

SECTION "sHack", SRAM, BANK[1]
; A copy of wHack with checksum
ds $1800 ; pad to $b800
sHacksum:: ds 1
sHackdata::
