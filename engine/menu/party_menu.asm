...
; 06: battle tent pokemon selection menu
...
.loop
	...
	pop hl
	push hl
	; I just know what caused the weird unfilled arrow bug
	;ld a, [hJoyInput]
	;cp SELECT ; attempt to swap with button
	;jr nz,.select
	ld a,[wMenuItemToSwap]
	and a ; is the player swapping pokemon positions?
	jr z,.skipUnfilledRightArrow ; if the player is swapping pokemon positions
.select
	dec a
	ld b,a
	ld a,[wWhichPokemon]
