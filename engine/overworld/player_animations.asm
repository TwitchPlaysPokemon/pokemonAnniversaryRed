...
RedGFishingTiles: ; 70866 (1c:4866)
	dw RedGFishingTilesFront
	db 2, BANK(RedGFishingTilesFront)
	dw vNPCSprites + $20

	dw RedGFishingTilesBack
	db 2, BANK(RedGFishingTilesBack)
	dw vNPCSprites + $60

	dw RedGFishingTilesSide
	db 2, BANK(RedGFishingTilesSide)
	dw vNPCSprites + $a0
