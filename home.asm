...
; The rst vectors are used for a hack.
SECTION "rst 00", ROM0 [$00]
	rst $38
SECTION "rst 08", ROM0 [$08]
	rst $38
	
CheckPlayerGender EQU $10 ; rst function label
SECTION "rst 10", ROM0 [CheckPlayerGender]
; Check player gender, carry if she's a girl. Get it? :P
	ld a, [wPlayerGender]
	and a
	ret z
	scf
...
IsOakable EQU $18
SECTION "rst 18", ROM0 [IsOakable]
; zero if red is fought and pokedex is completed and gym rematches are done
	ld a, [wRoamingFlag]
	and OAKABLE
	cp OAKABLE
	ret nz ; fall through rst $20
	
IsAllGymRematchesDone EQU $20
SECTION "rst 20", ROM0 [IsAllGymRematchesDone]
	ld a, [wRematchFlag]
	cp $ff
	ret
	
OverwriteRoster EQU $28
SECTION "rst 28", ROM0 [OverwriteRoster]
...
LoadPlayerCyclingSprite:
	ld de, RedCyclingSprite
	rst CheckPlayerGender
	ret nc
	ld de, RedGCyclingSprite
	ret
	
LegendaryCheck:
	callba _LegendaryCheck
	jr CheckRanOccured
...
PrintEndBattleText:: ; 3381 (0:3381)
	...
	ld a, [W_CURMAP]
	cp BATTLE_TENT ; endbattle text don't like custom text
