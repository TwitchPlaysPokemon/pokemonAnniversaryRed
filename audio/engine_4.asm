; The fourth (ugh...) duplicated sound engine.

Music2e_UpdateMusic:: ; 7d177 (1f:5177)
	ld c, CH0
.loop
	ld b, $0
	ld hl, wc026
	...
	jr .nextChannel
.applyAffects
	call Music2e_ApplyMusicAffects
.nextChannel
	ld a, c
...
Music2e_PlayNextNote: ; 7d244 (1f:5244)
	ld hl, wc06e
	add hl, bc
	ld a, [hl]
	ld hl, wc04e
	...
	res 4, [hl]
	res 5, [hl]
	call Music2e_endchannel
	ret

Music2e_endchannel: ; 7d25a (1f:525a)
	call Music2e_GetNextMusicByte
	ld d, a
	cp $ff ; is this command an endchannel?
	jp nz, Music2e_callchannel ; no
	ld b, $0 ; yes
	ld hl, wc02e
	add hl, bc
	bit 1, [hl]
...
.returnFromCall
	...
	jp Music2e_endchannel
.asm2_7d2b3
	ld hl, Unknown2_7db93
	add hl, bc
	ld a, [$ff25]
	and [hl]
	ld [$ff25], a
...
Music2e_callchannel: ; 7d2e8 (1f:52e8)
	cp $fd ; is this command a callchannel?
	jp nz, Music2e_loopchannel ; no
	call Music2e_GetNextMusicByte ; yes
	push af
	call Music2e_GetNextMusicByte
	ld d, a
	pop af
...
Music2e_loopchannel: ; 7d31d (1f:531d)
	cp $fe ; is this command a loopchannel?
	jp nz, Music2e_notetype ; no
	call Music2e_GetNextMusicByte ; yes
	ld e, a
	and a
	jr z, .infiniteLoop
	...
	ld [hl], a
	call Music2e_GetNextMusicByte ; skip pointer
	call Music2e_GetNextMusicByte
	jp Music2e_endchannel
...
Music2e_notetype: ; 7d358 (1f:5358)
	and $f0
	cp $d0 ; is this command a notetype?
	jp nz, Music2e_toggleperfectpitch ; no
	ld a, d ; yes
	and $f
	ld b, $0
	ld hl, wc0c6
...
Music2e_toggleperfectpitch: ; 7d397 (1f:5397)
	ld a, d
	cp $e8 ; is this command a toggleperfectpitch?
	jr nz, Music2e_vibrato ; no
	ld b, $0 ; yes
	ld hl, wc02e
	add hl, bc
	ld a, [hl]
...
Music2e_vibrato: ; 7d3a9 (1f:53a9)
	cp $ea ; is this command a vibrato?
	jr nz, Music2e_pitchbend ; no
	call Music2e_GetNextMusicByte ; yes
	ld b, $0
	ld hl, wc04e
	add hl, bc
...
Music2e_pitchbend: ; 7d3e1 (1f:53e1)
	cp $eb ; is this command a pitchbend?
	jr nz, Music2e_duty ; no
	call Music2e_GetNextMusicByte ; yes
	ld b, $0
	ld hl, wc076
	add hl, bc
	...
	call Music2e_GetNextMusicByte
	ld d, a
	jp Music2e_notelength

Music2e_duty: ; 7d419 (1f:5419)
	cp $ec ; is this command a duty?
	jr nz, Music2e_tempo ; no
	call Music2e_GetNextMusicByte ; yes
	rrca
	rrca
	and $c0
...
Music2e_tempo: ; 7d42e (1f:542e)
	cp $ed ; is this command a tempo?
	jr nz, Music2e_stereopanning ; no
	ld a, c ; yes
	cp CH4
	jr nc, .sfxChannel
	call Music2e_GetNextMusicByte
...
Music2e_stereopanning: ; 7d46e (1f:546e)
	cp $ee ; is this command a stereopanning?
	jr nz, Music2e_unknownmusic0xef ; no
	call Music2e_GetNextMusicByte ; yes
	ld [wc004], a ; store panning
	jp Music2e_endchannel

; this appears to never be used
Music2e_unknownmusic0xef: ; 7d47b (1f:547b)
	cp $ef ; is this command an unknownmusic0xef?
	jr nz, Music2e_dutycycle ; no
	call Music2e_GetNextMusicByte ; yes
	push bc
	call Func2_7d8ea
	pop bc
...
Music2e_dutycycle: ; 7d49a (1f:549a)
	cp $fc ; is this command a dutycycle?
	jr nz, Music2e_volume ; no
	call Music2e_GetNextMusicByte ; yes
	ld b, $0
	ld hl, wc046
	add hl, bc
...
Music2e_volume: ; 7d4b8 (1f:54b8)
	cp $f0 ; is this command a volume?
	jr nz, Music2e_executemusic ; no
	call Music2e_GetNextMusicByte ; yes
	ld [$ff24], a ; store volume
	jp Music2e_endchannel

Music2e_executemusic: ; 7d4c4 (1f:54c4)
	cp $f8 ; is this command an executemusic?
	jr nz, Music2e_octave ; no
	ld b, $0 ; yes
	ld hl, wc036
	add hl, bc
	set 0, [hl]
...
Music2e_octave: ; 7d4d3 (1f:54d3)
	and $f0
	cp $e0 ; is this command an octave?
	jr nz, Music2e_unknownsfx0x20 ; no
	ld hl, wc0d6 ; yes
	ld b, $0
	add hl, bc
	ld a, d
...
Music2e_unknownsfx0x20: ; 7d4e6 (1f:54e6)
	cp $20 ; is this command an unknownsfx0x20?
	jr nz, Music2e_unknownsfx0x10 ; no
	ld a, c
	cp CH3 ; is this a noise or sfx channel?
	jr c, Music2e_unknownsfx0x10 ; no
	ld b, $0
	ld hl, wc036
	add hl, bc
	bit 0, [hl]
	jr nz, Music2e_unknownsfx0x10 ; no
	call Music2e_notelength ; yes
	ld d, a
	ld b, $0
	ld hl, wc03e
	add hl, bc
...
Music2e_unknownsfx0x10 ; 7d533 (1f:5533)
	ld a, c
	cp CH4
	jr c, Music2e_note ; if not a sfx
	ld a, d
	cp $10 ; is this command an unknownsfx0x10?
	jr nz, Music2e_note ; no
	ld b, $0
	ld hl, wc036
	add hl, bc
	bit 0, [hl]
...
Music2e_note: ; 7d54f (1f:554f)
	ld a, c
	cp CH3
	jr nz, Music2e_notelength ; if not noise channel
	ld a, d
	and $f0
	cp $b0 ; is this command a dnote?
	jr z, Music2e_dnote ; yes
	jr nc, Music2e_notelength ; no
	swap a
	ld b, a
	ld a, d
	and $f
...
Music2e_dnote: ; 7d569 (1f:5569)
	ld a, d
	and $f
	push af
	push bc
	call Music2e_GetNextMusicByte ; get dnote instrument
asm2_7d571
	ld d, a
	ld a, [wc003]
	and a
...
Music2e_notelength: ; 7d57e (1f:557e)
	ld a, d
	push af
	and $f
	inc a
...
.skip
	...
	add hl, bc
	bit 0, [hl]
	jr nz, Music2e_notepitch
	ld hl, wc02e
	add hl, bc
	bit 2, [hl]
	jr z, Music2e_notepitch
	pop hl
	ret

Music2e_notepitch: ; 7d5dc (1f:55dc)
	pop af
	and $f0
...
Func2_7d66c: ; 7d66c (1f:566c)
	ld b, $0
	ld hl, Unknown2_7db9b
	add hl, bc
	ld a, [$ff25]
	or [hl]
	ld d, a
...
Music2e_ApplyPitchBend: ; 7d76d (1f:576d)
	ld hl, wc02e
	add hl, bc
	bit 5, [hl]
	jp nz, .asm2_7d7b4
...
Music2e_ApplyDutyCycle: ; 7d881 (1f:5881)
	ld b, $0
	ld hl, wc046
	add hl, bc
	ld a, [hl]
...
Music2e_GetNextMusicByte: ; 7d899 (1f:5899)
	ld d, $0
	ld a, c
	add a
	ld e, a
...
Func2_7d8ac: ; 7d8ac (1f:58ac)
	ld a, c
	ld hl, Unknown2_7db8b
	add l
	jr nc, .noCarry
	inc h
.noCarry
...
Func2_7d8cc: ; 7d8cc (1f:58cc)
	ld h, $0
	ld l, a
	add hl, hl
	ld d, h
	ld e, l
	ld hl, Music2e_Pitches
	add hl, de
	ld e, [hl]
	inc hl
	ld d, [hl]
