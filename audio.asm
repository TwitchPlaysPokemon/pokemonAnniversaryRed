...
INCLUDE "audio/headers/sfxheaders2e.asm"
...
PlayBattleMusic:: ; 0x90c6
	...
	call DelayFrame
	jpba _PlayBattleMusic ; this bank is so damn filed up
...
INCLUDE "audio/music/silence.asm"
...
INCLUDE "audio/music/gen2championbattle.asm"
...
INCLUDE "audio/sfx/sfx_2e_pokeflute.asm"
INCLUDE "audio/sfx/sfx_2e_unused2.asm"
INCLUDE "audio/sfx/sfx_2e_3a.asm"
INCLUDE "audio/sfx/sfx_2e_3b.asm"
INCLUDE "audio/sfx/sfx_2e_46.asm"
INCLUDE "audio/music/defeatedtrainer.asm"
INCLUDE "audio/music/defeatedwildmon.asm"
INCLUDE "audio/music/defeatedgymleader.asm"
INCLUDE "audio/music/leech.asm"

IF (SFX_08_77 - SFX_Headers_08) / 3 != (SFX_2e_77 - SFX_Headers_2e) / 3
	FAIL "not match!"
ENDC